...
const BANDS = [
  ...
  { name: 'ABYSS',    color: '#3A70CC', start: 201, end: 210 },
  { name: 'PRIMAL',   color: '#CC1177', start: 211, end: 220 },
  { name: 'VORTEX',   color: '#2EBB44', start: 221, end: 230 },
  { name: 'CRIMSON',  color: '#EE2222', start: 231, end: 240 },
  { name: 'NEBULA',   color: '#9944DD', start: 241, end: 250 },
  { name: 'TEMPEST',  color: '#00AAAA', start: 251, end: 260 },
  { name: 'QUASAR',   color: '#E86000', start: 261, end: 270 },
  { name: 'SERAPH',   color: '#6688BB', start: 271, end: 280 },
  { name: 'COSMOS',   color: '#4477AA', start: 281, end: 290 },
  { name: 'GENESIS',  color: '#E85500', start: 291, end: 300 },
];
